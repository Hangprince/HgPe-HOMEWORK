...
这周主要查找整理了一些资料，阅读了一些论文（例如：《中国传统民族乐器与西洋乐器的异同》）尝试搜集数据，但是民乐类的数据真的很难找，感觉是个不小的坑，我本想在艺术水平考级网上看看能不能找到全国报名民族乐器和西洋乐器的有多少人，但是未果。之后，我在翻看相关调查报告（例如：《关于社会音乐考级的调查报告》）的时候，找到了一些调查的数据。
